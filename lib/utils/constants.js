...
module.exports = {
  DEBUG: false,
  LOG_LEVEL: "info",
  AGENT_TYPE: "bitsky-service-producer",
  ...
  DEFAULT_AGENT_CONFIGURATION: {
    ...
    timeout: 90,
    maxRetry: 1, // Max retry time that producer will try to execute an intelligence
  },
  ...
  POLLING_INTERVAL_WATCH_AGENT: 30 * 1000, // How frequently to check producer configuration change
