...
/**
 * Get Tasks that need to collect from DIA Server
 * @returns [] - Tasks
 */
...
function filterTasksSendToDIA(tasks) {
  let filterTasks = [];
...
async function updateTasksAPI(
  ...
  return new Promise((resolve, reject) => {
    ...
    http(
      {
        method: constants.DIA_UPDATE_TASKS_METHOD,
        url,
        headers,
        data: filterTasksSendToDIA(tasks),
      },
      context
    )
      .then((res) => {
